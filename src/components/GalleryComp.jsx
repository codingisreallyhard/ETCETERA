...
import Image from "../assets/1536075490tt.png";
function GalleryComp() {
  ...
  return (
    <>
      ...
      >
        <motion.div variants={svgContainer} className="absolute z-50 flex">
          ...
          <img
            ...
            src={Image}
            alt="tattoo"
            className="text-white -translate-y-12  w-96 h-96"
          ></img>
        </motion.div>
      ...
      <h2 className="text-white  text-center pt-12 text-5xl royaltype mb-16">
        GALLERY
      </h2>
